...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { address: @practice.address, keys: @practice.keys, name: @practice.name } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { address: @practice.address, keys: @practice.keys, name: @practice.name } }
